...
<header class="flex items-center justify-between p-4 bg-white dark:bg-gray-800 shadow">
    ...
    <!-- Only this line below had overflow-visible added earlier -->
    <div class="flex items-center space-x-2 relative overflow-visible">
        ...
        <div class="relative">
            <button id="avatarBtn" class="focus:outline-none flex items-center justify-center h-10 w-10 rounded-full bg-gray-200 dark:bg-gray-700">
            ...
            <!-- ✅ Dropdown fixed here: changed top-full mt-2 to top-12 -->
            <div id="avatarDropdown" class="absolute right-0 top-12 min-w-48 max-w-xs bg-white dark:bg-gray-800 rounded-lg shadow-lg py-2 z-[9999] transition-all duration-200 hidden" style="display: none;">
